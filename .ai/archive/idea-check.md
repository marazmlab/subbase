...
- View a structured subscription list with key details for fast, hassle-free management
- Showinh monthly all subscriptions costs
- Secure user accounts that link each user to their own private subscription database
- AI-powered insights that detect overlapping services and recommend ways to optimize your subscriptions

## 🔻 Whats NOT included in an MVP?

- Manage subscriptions individually
