  ...
  return (
    ...
    >
      <TabsList className="grid w-full grid-cols-2">
        <TabsTrigger value="login" data-test-id="auth-tab-login">Logowanie</TabsTrigger>
        <TabsTrigger value="register" data-test-id="auth-tab-register">Rejestracja</TabsTrigger>
      </TabsList>
